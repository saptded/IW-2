...
TEST(print_matrix, print_matrix) {
    ...
    print_matrix(mat_exp, "../matrix_data/test_mat_forked.txt");

    Matrix *mat_got = create_matrix_from_file("../matrix_data/test_mat_forked.txt");
...
TEST(print_cols_sum, print_cols_sum) {
    ...
    cols_sum(mat);
    print_cols_sum(mat, "../matrix_data/test_cols_sum_forked.txt");

    double col_sum = 0;
    FILE *ptr = fopen("../matrix_data/test_cols_sum_forked.txt", "r");
...
TEST(time, time) {
    Matrix *mat = create_matrix(1000, 500);
    ...
    FILE *ptr = fopen("../matrix_data/test_time_forked.txt", "w+");
